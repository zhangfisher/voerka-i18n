    ...
    <div className="max-w-sm p-6 flex-col grow bg-white border border-gray-200 rounded-lg shadow-sm " >
      ...
      <div className="font-normal text-gray-700 dark:text-gray-400 py-4">
        ...
        <ul className="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400 rounded-lg bg-gray-50 p-2">
            <li className="cursor-pointer p-2 flex items-center hover:bg-gray-100 hover:rounded">
        ...
        <h2 className="my-2 text-lg text-center font-semibold dark:text-white text-emerald-600 py-2">
