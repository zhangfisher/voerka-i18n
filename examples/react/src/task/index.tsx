import { Edit, CircleX, SquareCheckBig, ClipboardCheck, Square, ClipboardPlus, ListTodo, LayoutList, ListChecks, Trash2 } from "lucide-react"
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                <th scope="col" className="px-6 py-3 w-0.5"></th>
                <th scope="col" className="px-6 py-3"> <Translate message="标题"/></th>
                <th scope="col" className="px-6 py-3"> <Translate message="描述"/></th>
                <th scope="col" className="px-6 py-3"> <Translate message="创建于"/></th>
                <th scope="col" className="px-6 py-3"> <Translate message="完成"/></th>
                <th scope="col" className="px-6 py-3"> <Translate message="动作"/></th>
              </tr>
            </thead>
            <tbody>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 flex-nowrap flex flwx-row">
                      ...
                      <button
                        type="button"
                        title={t("删除")}
                        className="cursor-pointer hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500"
                      > <CircleX  size="16"/> 
                      </button>
                    </td>
                  </tr>
