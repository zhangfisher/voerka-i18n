  ...
  <div class="mx-auto max-w-2xl py-8 border-b-1 border-gray-200">
    <div class="hidden sm:mb-8 sm:flex sm:justify-center">
      <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
        ...
        <a href="#d" class="font-semibold text-indigo-600">
    ...
    <div class="text-center">
      <div class="self-center text-lg whitespace-nowrap dark:text-white colorized-title">
        VoerkaI18n
      </div>
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
        ...
        <a href="#d" class="text-sm/6 font-semibold text-gray-900">
