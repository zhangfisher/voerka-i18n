...
export class VoerkaI18nScope {
    ...
    private _init(){
        ...
        // 等待全局VoerkaI18nManager准备就绪
        this._manager.once('init',this._onInitial.bind(this))
    }
    /**
     * 
     * 所有用i18nScope初始化时均会注册到全局VoerkaI18nManager中
     * 
     * 
     * @param param0 
     */
    private async _onInitial({scope,language}:{scope:string,language:string}){  
