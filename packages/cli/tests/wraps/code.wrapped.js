...
program
    ...
    .description(t('调用在线翻译服务商的API翻译译指定项目的语言包,使用百度云翻译服务'))
    .option('--no-backup', t('备份原始文件'))
    .option('--mode', t('翻译模式，取值auto=翻译未翻译的,full=全部翻译'), 'auto')
    .option('-p, --provider <value>', t('在线翻译服务提供者名称或翻译脚本文件'), 'baidu')
    .option('-m, --max-package-size <value>', t('将多个文本合并提交的最大包字节数'), 200)
    .option('--appid [id]', t('API IDD'))
    .option('--appkey [key]', t('API密钥'))
    .option('-q, --qps <value>', t('翻译速度限制,每秒可调用的API次数'), 1)  
