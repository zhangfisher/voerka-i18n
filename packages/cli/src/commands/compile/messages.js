 ...
 */
async function compileMessagesFile(language,allMessages){
...
async function compileMessages(allMessages){
    const { tasks,langRelDir, languages,typescript, moduleType } = this
    ...
    for(let language of languages){
        try{
            ...
            await compileMessagesFile.call(this, language, allMessages)
            tasks.complete()
        }catch(e){
            tasks.error(e)
        }
