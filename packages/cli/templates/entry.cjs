...
{{if activeLanguage !== defaultLanguage}}const activeFormatters = require("./formatters/{{activeLanguage}}.js"){{/if}}
{{if activeLanguage !== defaultLanguage}}const activeMessages = require("./{{activeLanguage}}.js"){{/if}}
